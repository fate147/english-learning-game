...
import { SAMPLE_QUESTIONS } from '../lib/math/sample.js'
import { useStars } from '../hooks/useStars.js'

const TOTAL = SAMPLE_QUESTIONS.length

export default function DemoMath() {
      ...
      <PageShell className="bg-math">
        <div className="min-h-screen flex items-center justify-center p-4">
          <Card className="max-w-sm w-full text-center py-8 page-enter">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">题目侦探</h2>
            <p className="text-gray-400 mb-6">完成！</p>
            <Card className="mb-6">
              <div className="text-4xl font-bold text-emerald-500">{score}/{TOTAL}</div>
              <div className="text-sm text-gray-500 mt-1">数学理解</div>
            </Card>
  ...
  return (
    <PageShell className="bg-math min-h-screen">
